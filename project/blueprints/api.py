...
def _sanitize_for_matching(text: str) -> str:
    ...
    junk_words = ['final', 'mix', 'mono', 'stereo', 'master', 'episode', 'ep']
    ...
    for xml_path in all_xml_files:
        try:
            ...
            for item in tree.findall('channel/item'):
                ...
                xml_title_text = ""
                if itunes_title_element is not None and itunes_title_element.text:
                    xml_title_text = itunes_title_element.text
                elif title_element is not None and title_element.text:
                    xml_title_text = title_element.text
